...
const Home = () => {
  return (
    <section className="bg-white min-h-screen flex flex-grow gap-3 overflow-y-auto custom-overflow-hidden pb-40">
      ...
      <div className="flex justify-center items-center ">
        <div className="flex flex-col items-center justify-center m-30 ">
          ...
          <p className="text-[#122620] text-lg text-center max-w-md mb-6 px-2">
            Join the best Online Quran Academy to learn Quran online with expert
            tutors. Get Islamic education from the comfort of your home.
          </p>
